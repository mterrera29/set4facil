    ...
    >
      ...
      <AccordionDetails>
        ...
        {dataItems.form.escuelaDatos.map((item) => (
          <Form.Group className='mb-3' key={item.register}>
            ...
            <TextField
              ...
              defaultValue={
                defaultData
                  ? defaultData.escuelas?.[`escuela${escuela.id}`]?.[
                      item.register
                    ]
                  : ''
              }
              {...register(`escuelas[escuela${escuela.id}].${item.register}`)}
            />
          </Form.Group>
        ))}
            ...
            >
              {dataItems.form.escuelaFecha.map((items) => (
                ...
                >
                  ...
                  <Form.Select
                    {...register(
                      `escuelas[escuela${escuela.id}].${items.register}`
                    )}
                    defaultValue={
                      defaultData
                        ? defaultData.escuelas?.[`escuela${escuela.id}`]?.[
        ...
        <Button
          ...
          color='error'
          onClick={() => {
            eliminarEscuela(index, escuela.id);
          }}
          className='mb-3'
        >
          {' '}
